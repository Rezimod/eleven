...
- **On-chain program IDs are pinned to the verified TxOracle addresses:** devnet `6pW64gN1s2uqjHkn1unFeEjAwJkPGHoppGvS715wyP2J`, mainnet `9ExbZjAapQww1vfcisDmrngPinHTEfpjYRWMunJgcKaA`. The exact `validate_stat` account order is a documented **TODO** pending the public IDL (see §5 TxLINE feedback).
